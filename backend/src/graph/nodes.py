...
def audit_content_node(state: VideoAuditState) -> Dict[str, Any]:
    ...
    embeddings = AzureOpenAIEmbeddings(
        azure_deployment=os.getenv("AZURE_OPENAI_EMBEDDING_DEPLOYMENT"),  # Must match your Azure deployment name
        azure_endpoint=os.getenv("AZURE_OPENAI_EMBEDDING_ENDPOINT"),  # Add this
        api_key=os.getenv("AZURE_OPENAI_EMBEDDING_API_KEY"),  # Add this
        openai_api_version=os.getenv("AZURE_OPENAI_API_VERSION"),
    )
